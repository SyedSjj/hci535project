					...
					<form method="POST" action="./partner.php" >
						<div class="box-body">
							...
							<div class='box-body pad' style="padding: 0px;">
								<form>
									<textarea class="textarea" placeholder="Comments/Notes about it" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
								</form>
							</div>
